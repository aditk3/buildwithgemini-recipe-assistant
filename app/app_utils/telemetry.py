...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=simple-agent,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        _default_instrumentor_builder(project_id or "qwiklabs-gcp-03-5bec0b757af4", enable_tracing=True, enable_logging=True)
