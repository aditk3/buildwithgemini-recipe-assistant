...
setup_agent_engine_telemetry()
try:
    logging_client = google_cloud_logging.Client(project="qwiklabs-gcp-03-5bec0b757af4")
...
@app.get("/api/recipes")
@app.get("/recipes")
def list_all_recipes_endpoint() -> list[dict]:
    """HTTP GET endpoint to retrieve all recipes from Firestore database."""
    from app.firestore_tools import recipes_col
    try:
